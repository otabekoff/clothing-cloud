...
def seed(db: Session) -> None:
    ...
    products = [
        ...
        models.Product(sku="DN-SL-014", name="Slim Fit Denim", category="Bottoms", unit_price=12.90),
        ...
        models.Product(sku="JK-BM-440", name="Bomber Jacket", category="Outerwear", unit_price=22.40),
    ]
    db.add_all(products)
    db.flush()
    ...
    customers = [
        models.Customer(name="Silk Road Retail", region="Tashkent", email="orders@silkroad.example"),
