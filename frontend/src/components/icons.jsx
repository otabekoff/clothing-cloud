...
// Keeping them local avoids an icon-library dependency.
...
export const Icon = {
  ...
  box: (p) => (
    <svg {...base} {...p}><path d="M21 16V8a2 2 0 0 0-1-1.7l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.7l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><path d="m3.3 7 8.7 5 8.7-5" /><path d="M12 22V12" /></svg>
  ),
  warehouse: (p) => (
    <svg {...base} {...p}><path d="M22 8.3V21H2V8.3l10-5z" /><path d="M6 21v-7h12v7" /><path d="M6 17h12" /></svg>
  ),
  users: (p) => (
  ...
  alert: (p) => (
    <svg {...base} {...p}><path d="m10.3 3.9-8.1 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>
  ),
  plus: (p) => (
